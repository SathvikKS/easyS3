...
## Corpus Check
- 68 files · ~21,384 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 443 nodes · 748 edges · 26 communities (23 shown, 3 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `133c0118`
...
Cohesion: 0.08
Nodes (44): ActionBar(), FileCard(), FileCardProps, FileIcon(), FileIconProps, FileListHeader(), FileRow(), FileRowProps (+36 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (37): ActionBarProps, LayoutToggle(), LayoutToggleProps, SortableHeader(), Crumb, NavBarProps, NavButton(), NavButtonProps (+29 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (34): registerConnectionIpcHandlers(), registerIpcHandlers(), registerSettingsIpcHandlers(), assertTrustedSender(), isTrustedWebContents(), parseOptionalPath(), parseSettingKey(), parseSettingValue() (+26 more)
...
Cohesion: 0.16
Nodes (18): Connection, ConnectionFormValues, ConnectResult, formatLastSeen(), toConnection(), addConnection(), ConnectionsData, CredentialPair (+10 more)
...
Cohesion: 0.06
Nodes (40): AddConnectionDialog(), AddConnectionDialogBody(), AddConnectionDialogProps, DialogBodyProps, FieldDef, FIELDS, FileViewer(), FileViewerProps (+32 more)
...
## Knowledge Gaps
- **183 isolated node(s):** `name`, `version`, `description`, `main`, `author` (+178 more)
